...
_start:
    ...
    add al, [num2]           ; Sumar el valor de num2 al AL
    ...
    add al, 49               ; Se aumenta el valor para que 16+49 sea 65 (que es la letra 'A' en ASCII)
    ...
    mov edx, 12              ; longitud del mensaje a imprimir
    int 0x80                 ; Llamar al kernel para realizar la escritura ; Imprimir el resultado
    mov eax, 4               ; syscall: sys_write
    mov ebx, 1               ; file descriptor: stdout (salida estándar)
    mov ecx, buffer          ; puntero al buffer que contiene el carácter ASCII
    mov edx, 1               ; longitud del buffer (1 byte: carácter ASCII)
    int 0x80                 ; Llamar al kernel para realizar la escritura; Salir
