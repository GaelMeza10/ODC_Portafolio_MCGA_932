...
section .bss
    buffer resb 10             ; Buffer más grande para convertir números a caracteres (suficiente para valores grandes)
...
.next_digit:
    ...
    mov edx, buffer + 10       ; Longitud máxima asumida en 10 dígitos
    sub edx, ecx               ; Calcula la longitud real
